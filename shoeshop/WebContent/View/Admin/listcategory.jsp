					...
					<div class="col-lg-12">
						<div class="box">
							<header>
								...
								<h3 style="color: #dc3545; margin-left: 20px">Danh sách thông tin loại sản phẩm</h3>
                        <c:choose>
 				 			  <c:when test="${not empty messageAdminActionCategory}"><h4 style="color: red; margin-left: 20px">${messageAdminActionCategory}</h4></c:when> 
   							  <c:otherwise></c:otherwise> 
               			</c:choose>
							</header>
							<div id="collapse4" class="body">
							<a class="btn btn-success" href="AdminAddCategory"><i
									class="glyphicon glyphicon-plus"></i>&nbsp; Thêm </a>
							<a class="btn btn-success" href="#"><i
									class="glyphicon glyphicon-import"></i>&nbsp; Import </a>
						    <a class="btn btn-success" href="AdminExportCategory"><i
										...
										<c:forEach items="${listCategory}" var="category">
											<tr>
												...
												<td><a class="btn btn-primary"
													href="AdminEditInfoCategory?id_category=${category.id}"><i
														class="glyphicon glyphicon-edit"></i>&nbsp;Sửa</a> 
														
												
														<a class="btn btn-danger"
													href="AdminRemoveCategory?id_category=${category.id}"><i
