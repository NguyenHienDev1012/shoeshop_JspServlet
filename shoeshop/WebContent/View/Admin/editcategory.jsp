			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="box dark">
							<header>
								<h3 style="color: #dc3545; margin-left: 20px">Sửa thông tin
									loại sản phẩm</h3>
								<!-- .toolbar -->
								<br>
								<div class="toolbar">
							...
							<div id="div-1" class="body">
								<form class="form-horizontal" method="POST"
									action="AdminEditInfoCategory">
									<div class="form-group">
										<label class="control-label col-lg-2">Mã loại: </label>

										<div class="col-lg-4">
											<input type="text" value="${category.getId()}"
												readonly="readonly" class="form-control" name="id_category">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" value="${category.getName()}"
										...
										<div class="box">
											...
											<div class="body">
												<textarea id="ckeditor" class="ckeditor"
													name="description_category">${category.getDescription()}</textarea>
