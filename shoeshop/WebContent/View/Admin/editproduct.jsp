			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="box dark">
							<header>
								<h3 style="color: #dc3545;margin-left: 20px">Sửa thông tin sản phẩm</h3>
								<!-- .toolbar -->
								<br>
								<div class="toolbar">
							...
							<div id="div-1" class="body">
								<form class="form-horizontal" method="POST" action="AdminEditInfoProduct">
									<div class="form-group">
										<label class="control-label col-lg-2">Mã sản phẩm: </label>

										<div class="col-lg-4">
											<input type="text" value="${product.id}" readonly="readonly"
									...
									<label class="control-label col-lg-2">Giảm giá: </label>
										...
										<div class="col-lg-4">
											<input type="text" value="${product.sale}"
									...
									<label class="control-label col-lg-2">Yêu thích sản phẩm: </label>
										...
										<div class="col-lg-4">
											<input type="text" value="${product.tymNumber}"
							       ...
							       <div class="form-group">
									<label class="control-label col-lg-2">Mã loại sản phẩm: </label>
										...
										<div class="col-lg-4">
											<input type="text" value="${product.id_Category}"
									    ...
									    <div class="col-lg-10">
									        <div class="box">
									            ...
									            <div class="body">
									                    <textarea id="ckeditor" class="ckeditor" name="description_product">${product.description}</textarea>
									...
									<input type="submit" value="Cập nhật" style="margin-bottom: 57px; margin-left: 240px" class="btn btn-primary">
										 <br> <br> <br> <br> <br> <br> 
								</form>
							</div>
						</div>
