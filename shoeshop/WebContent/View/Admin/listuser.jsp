			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<h3 style="color: #dc3545; margin-left: 20px">Danh sách tài	khoản khách hàng</h3>
                        <c:choose>
 				 			 <c:when test="${not empty messageAdminActionUser}"><h4 style="color: red; margin-left: 20px">${messageAdminActionUser}</h4></c:when> 
										...
										<c:forEach items="${listUser}" var="user">
											<tr>
												...
												<td><a class="btn btn-primary"
													href="AdminEditInforUser?id_user=${user.id}"><i
														class="glyphicon glyphicon-edit"></i>&nbsp; Sửa</a>
												<a class="btn btn-danger"
													href="AdminRemoveUser?id_user=${user.id}"><i
