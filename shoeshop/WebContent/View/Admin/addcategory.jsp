			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="box dark">
							<header>
								<h3 style="color: #dc3545;margin-left: 20px">Thêm loại sản phẩm</h3>
								<!-- .toolbar -->
								<br>
								<div class="toolbar">
							...
							<div id="div-1" class="body">
								<form class="form-horizontal" method="POST" action="AdminAddCategory">
									<div class="form-group">
									<label class="control-label col-lg-2">Tên loại: </label>

										<div class="col-lg-4">
											<input type="text"
												class="form-control" name="name_category">
										</div>
									</div>
									    ...
									    <div class="col-lg-10">
									        <div class="box">
									            ...
									            <div class="body">
									                    <textarea id="ckeditor" class="ckeditor" name="description_category"></textarea>
									...
									<input type="submit" value="Thêm" style="margin-bottom: 57px; margin-left: 240px" class="btn btn-success" class="glyphicon glyphicon-plus">
										 <br> <br> <br> <br> <br> <br> 
								</form>
							</div>
						</div>
