			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="box dark">
							<header>
	             <h3 style="color: #dc3545;margin-left: 20px">Sửa tài khoản khách hàng</h3>
								<!-- .toolbar -->
								<div class="toolbar">
							...
							<div id="div-1" class="body">
								<form class="form-horizontal" method="post" action="AdminEditInforUser">
									<div class="form-group">
										<label class="control-label col-lg-4">Mã khách hàng: </label>

										<div class="col-lg-8">
											<input type="text" name="id_user_str" value="${user.getId()}" readonly="readonly"
												class="form-control" >
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input class="form-control"  type="email" id="email" value="${user.getEmail()}" name="email"/>
										</div>
									</div>
									<div class="form-group">
										<label for="text1" class="control-label col-lg-4">Mật khẩu đã mã hóa: </label>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" value="${user.getRole()}"
								...
								<div class="form-group">
									...
									<input type="submit" value="Cập nhật"
										style="margin-bottom: 57px; margin-left: 240px" class="btn btn-primary">
								</form>
							</div>
						</div>
					</div>
